      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <p className="max-w-xl text-lg md:text-xl mb-12 border-l-4 border-black pl-6">
            Мы создаем цифровые продукты для тех, кто желает повысить продажи
            своего бизнеса. Чистый код, смелый дизайн, реальный результат.
          </p>
          <div className="flex flex-wrap gap-6">
            <a
              href="#contact"
              className="brutal-btn flex items-center gap-2 text-xl py-4 px-8"
            >
