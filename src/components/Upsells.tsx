  ...
  return (
    <section id="upsells" className="py-16 sm:py-24 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <h2 className="text-4xl sm:text-5xl md:text-7xl mb-4 uppercase">
        ...
        <div className="mt-12 bg-gray-50 border border-gray-200 border-l-4 border-l-black p-6">
          ...
          <p className="text-sm font-medium text-gray-700">
            Если нужна полноценная настройка воронки продаж, сложная логика в
            CRM или разработка сценариев для чат-бота — это обсуждается
            отдельно, т.к. требует погружения в бизнес-процессы.
          </p>
        </div>
      </div>
    </section>
